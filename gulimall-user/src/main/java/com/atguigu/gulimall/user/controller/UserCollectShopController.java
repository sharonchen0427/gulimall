...
import com.atguigu.gulimall.user.service.UserCollectShopService;
 ...
 */
@RestController
@RequestMapping("user/usercollectshop")
public class UserCollectShopController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("user:usercollectshop:list")
    ...
    //@RequiresPermissions("user:usercollectshop:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("user:usercollectshop:save")
    ...
    //@RequiresPermissions("user:usercollectshop:update")
    ...
    //@RequiresPermissions("user:usercollectshop:delete")
